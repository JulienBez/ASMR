#! /usr/bin/env python3
#python bin/evaluate.py --train FR/train.cupt --gold FR/test.cupt --pred system-results/ERMI.closed/FR/test.system.cupt
#evaulate.py is a file made by PARSEME shared-task participants. I just use it here to run some tests.
